...
module.exports = grammar({
    ...
    rules: {
        ...
        flow_vertex_ellipse: $ => seq( "(-", $._flow_text_slash, "-)" ),
        flow_vertex_stadium: $ => seq("([", $._flow_text_slash, "])"),
        flow_vertex_subroutine: $ => seq("[[", $._flow_text_slash, "]]"),
        flow_vertex_rect: $ => seq( "[|", $._flow_text_slash, "|]" ),
        flow_vertex_cylinder: $ => seq("[(", $._flow_text_slash, ")]"),
        flow_vertex_round: $ => seq("(", $._flow_text_slash, ")"),
        flow_vertex_diamond: $ => seq( "{", $._flow_text_slash, "}" ),
        flow_vertex_hexagon: $ => seq( "{{", $._flow_text_slash, "}}" ),
        flow_vertex_odd: $ => seq( ">", $._flow_text_slash, "]" ),
